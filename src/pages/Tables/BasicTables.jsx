...
const BasicTable = () => {
  //meta title
  document.title =
    "Basic Tables | Skote - Vite React Admin & Dashboard Template"
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    horizontal dividers—add the base className{" "}
              ...
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    ...
                    <code>&lt;thead&gt;</code>s appear light or dark
                    gray.
                  </CardSubtitle>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    Use <code>.table-striped</code> to add
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    Add <code>.table-bordered</code> for borders on
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    {" "}
                    Add <code>.table-borderless</code> for a table
                    without borders.
                  </CardSubtitle>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>.border-*</code>
                    for colored borders on all sides of the table and
                    cells.
                  </p>
                  <div className="table-responsive">
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add <code>.table-bordered</code> &{" "}
                    <code>.border-*</code> for colored borders on all
              ...
              <Card>
                <CardBody>
                  <div className="table-responsive">
                    ...
                    <p className="card-title-desc">
                      Table cells in <code>&lt;tbody&gt;</code>{" "}
                      inherit their alignment from{" "}
                      <code>&lt;table&gt;</code> and are aligned to
                      the the top by default. Use the vertical align
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    {" "}
                    Border styles, active styles, and table variants
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    Add <code>.table-hover</code> to enable a hover
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    {" "}
                    Add <code>.table-sm</code> to make tables more
          ...
          <Row>
            <Col lg={6}>
              <Card>
                <CardBody>
                  <CardTitle className="h4">
                    Contextual className{" "}
                  </CardTitle>
                  <CardSubtitle className="card-title-desc">
                    Use contextual className to color table rows or
                    individual cells.
                  </CardSubtitle>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="card-title-desc">
                    A <code>&lt;caption&gt;</code> functions like a
                    heading for a table. It helps users with screen
