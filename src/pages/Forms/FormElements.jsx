...
const FormElements = () => {
  ...
  const [customOutlinePrimary, setcustomOutlinePrimary] =
    useState(true)
  const [customOutlineSuccess, setcustomOutlineSuccess] =
    useState(true)
  const [customOutlineInfo, setcustomOutlineInfo] = useState(true)
  const [customOutlineWarning, setcustomOutlineWarning] =
    useState(true)
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Here are examples of <code>.form-control</code>{" "}
                    ...
                    <Col lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="card-title-desc">
                          ...
                          and max—0 and 100, respectively.
                        </p>
                        <input
                          type="range"
                          className="form-range"
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        ...
                        <p className="sub-header mb-4">
                          Add className <code>.form-check-* </code>{" "}
                        ...
                        <div>
                          <div className="form-check form-checkbox-outline form-check-primary mb-3">
                            <input
                              ...
                              onChange={() => {
                                setcustomOutlinePrimary(
                                  !customOutlinePrimary
                                )
                              }}
                            />
                            <label
                          ...
                          <div className="form-check form-checkbox-outline form-check-success mb-3">
                            <input
                              ...
                              onChange={() => {
                                setcustomOutlineSuccess(
                                  !customOutlineSuccess
                                )
                              }}
                            />
                            <label
                          ...
                          <div className="form-check form-checkbox-outline form-check-warning mb-3">
                            <input
                              ...
                              onChange={() => {
                                setcustomOutlineWarning(
                                  !customOutlineWarning
                                )
                              }}
                            />
                            <label
                  ...
                  <Row>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        ...
                        <p className="sub-header mb-4">
                          Add className{" "}
                          <code>form-radio-outline</code> &{" "}
                          <code>.form-radio-* </code> for a color
                          Checkboxes
                        </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    uses the <code>.form-switch</code> class to render
                    a toggle switch. Switches also support the{" "}
