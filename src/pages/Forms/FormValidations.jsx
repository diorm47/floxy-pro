...
const FormValidations = () => {
  ...
  function handleSubmit(e) {
    ...
    var unm = document.getElementById(
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Provide valuable, actionable feedback to your
                    users with HTML5 form validation–available in all
              ...
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Parsley is a availity reactstrap validation. It
                    helps you provide your users with feedback on
                    their form submission before sending it to your
                    server.
                  </CardSubtitle>
                  ...
                  >
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onBlur={validationType.handleBlur}
                        value={
                          validationType.values.alphanumeric || ""
                        }
                        invalid={
                  ...
                  >
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        value={
                          rangeValidation.values.min_Length || ""
                        }
                        invalid={
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onBlur={rangeValidation.handleBlur}
                        value={
                          rangeValidation.values.max_Length || ""
                        }
                        invalid={
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onBlur={rangeValidation.handleBlur}
                        value={
                          rangeValidation.values.range_Length || ""
                        }
                        invalid={
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onBlur={rangeValidation.handleBlur}
                        value={
                          rangeValidation.values.range_Value || ""
                        }
                        invalid={
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onBlur={rangeValidation.handleBlur}
                        value={
                          rangeValidation.values.regular_Exp || ""
                        }
                        invalid={
