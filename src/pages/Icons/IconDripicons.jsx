...
const IconDripicons = () => {
  //meta title
  document.title =
    "Dripicons | Skote - Vite React Admin & Dashboard Template"
              ...
              <Card>
                <CardBody>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-forward" />{" "}
                      dripicons-forward
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-gaming" />{" "}
                      dripicons-gaming
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-italic" />{" "}
                      dripicons-italic
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-jewel" />{" "}
                      dripicons-jewel
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-lifting" />{" "}
                      dripicons-lifting
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-return" />{" "}
                      dripicons-return
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-retweet" />{" "}
                      dripicons-retweet
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-rocket" />{" "}
                      dripicons-rocket
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-scale" />{" "}
                      dripicons-scale
                    </Col>
                    <Col xl="3" lg="4" sm="6">
