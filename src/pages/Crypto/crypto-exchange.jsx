...
const CryptoExchange = props => {
  //meta title
  document.title =
    "Exchange | Skote - Vite React Admin & Dashboard Template"
  ...
  const options = {
    ...
    plotOptions: {
      candlestick: {
        colors: { upward: "#34c38f", downward: "#f46a6a" },
      },
    },
    xaxis: { type: "datetime" },
  ...
  const notofications = [
    ...
    {
      date: "13 Mar",
      desc: "To achieve this, it would be necessary.",
    },
    {
      date: "12 Mar",
      desc: "Cum sociis natoque penatibus et magnis dis.",
    },
    {
      date: "11 Mar",
      desc: "New common language will be more simple and regular than the existing.",
                  ...
                  <div className="d-flex">
                    ...
                    >
                      ...
                      <DropdownMenu className="dropdown-menu-md dropdown-menu-end">
                        ...
                        <DropdownItem href="#">
                          BTC :{" "}
                          <span className="float-end">1.02356</span>
                        </DropdownItem>
                        <DropdownItem href="#">
                          ETH :{" "}
                          <span className="float-end">0.04121</span>
                        </DropdownItem>
                        <DropdownItem href="#">
                          LTC :{" "}
                          <span className="float-end">0.00356</span>
                        </DropdownItem>
            ...
            <Col xl="4">
              <Card>
                <CardBody>
                  ...
                  <div>
                    <p className="text-muted mb-2">
                      <i className="mdi mdi-wallet me-1" /> Wallet
                      Balance
                    </p>
                    <h5>$ 9148.23</h5>
                  </div>
