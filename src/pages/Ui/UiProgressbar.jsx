...
const UiProgressbar = () => {
  //meta title
  document.title =
    "Progress Bars | Skote - Vite React Admin & Dashboard Template"
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    We only set a{" "}
                    <code className="highlighter-rouge">height</code>{" "}
                    value on the{" "}
                    <code className="highlighter-rouge">
                      .progress-bar
                    </code>
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>.progress-bar</code> to animate the stripes
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>.progress-bar</code> for animated
                    progressbar.
                  </p>
                </CardHeader>
                <CardBody>
          ...
          <Row>
            <Col xl="6">
              <Card>
                ...
                <CardBody>
                  <p className="card-title-desc">
                    You can use these classes with existing components
                    to create new ones.
                  </p>
                  <div className="mt-5">
