...
const UiPlaceholders = () => {
  //meta title
  document.title =
    "Placeholders | Skote - Vite React Admin & Dashboard Template"
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    component and recreate it with placeholders
                    applied to create a “loading card”. Size and
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>.placeholder</code> class and a grid column
                    class (e.g., <code>.col-6</code>) to set the{" "}
                    <code>width</code>. They can replace the text
                    inside an element or be added as a modifier class
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>currentColor</code>. This can be overridden
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>.placeholder-glow</code> or{" "}
                    <code>.placeholder-wave</code> to better convey
                    the perception of something being{" "}
