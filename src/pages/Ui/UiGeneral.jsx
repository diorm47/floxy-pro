...
const UiGeneral = () => {
  //meta title
  document.title =
    "General | Skote - Vite React Admin & Dashboard Template"
                  ...
                  <Row>
                    ...
                    <Col lg={6}>
                      ...
                      <p className="card-title-desc">
                        ...
                        className to make badges more rounded (with a
                        larger <code>border-radius</code>
                      ...
                      <div className="mt-5">
                        ...
                        <div className="mt-1">
                          <Badge
                            pill
                            className="badge-soft-primary ms-1"
                          >
                            Primary
                          </Badge>
                          <Badge
                          ...
                          <Badge
                            pill
                            className="badge-soft-info ms-1"
                          >
                            Info
                          </Badge>
                          <Badge
                            pill
                            className="badge-soft-warning ms-1"
                          >
                            Warning
                          </Badge>
                          <Badge
                            pill
                            className="badge-soft-danger ms-1"
                          >
                            Danger
                          </Badge>
                          <Badge
                            pill
                            className="badge-soft-dark ms-1"
                          >
                            Dark
                          </Badge>
                        </div>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Four options are available: top, right, bottom,
                    and left aligned. Directions are mirrored when
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    If you don’t fancy a border spinner, switch to the
                    grow spinner. While it doesn’t technically spin,
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Provide an option to dismiss or close a component
                    with <code>.btn-close</code>. Default styling is
                    limited, but highly customizable. Modify the Sass
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>pointer-events: none</code> and{" "}
                    <code>user-select: none</code> to preventing hover
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Change the default <code>.btn-close</code> to be
                    white with the <code>.btn-close-white</code>{" "}
                    class. This class uses the <code>filter</code>{" "}
