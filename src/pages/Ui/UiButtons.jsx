...
const UiButtons = () => {
  //meta title
  document.title =
    "Buttons | Skote - Vite React Admin & Dashboard Template"
            ...
            <Col xl={12}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Use class <code>.btn-soft*</code> for soft
                    buttons.
                  </p>
                  <div className="d-flex flex-wrap gap-2">
                    <Button
                    ...
                    <div className="col-lg-4">
                      <div className="mt-4">
                        ...
                        <div className="d-flex flex-wrap gap-2">
                          ...
                          >
                            <i className="bx bx-loader label-icon "></i>{" "}
                            Dark
                          </button>
                          <button
                            type="button"
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Add <code>.btn-lg</code> or <code>.btn-sm</code>{" "}
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    className for additional buttons width.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    element. However, you can also use these classes
                    on{" "}
                    <code className="highlighter-rouge">
                      &lt;Link&gt;
                    </code>{" "}
                    ...
                    elements (though some browsers may apply a
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    state. If you’re pre-toggling a button, you must
                    manually add the{" "}
                    <code className="highlighter-rouge">
                      .active
                    </code>{" "}
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Create block level buttons—those that span the
                    full width of a parent—by adding{" "}
                    <code className="highlighter-rouge">
                      .btn-block
                    </code>
                    .
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    containing those modified buttons to enable
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    for more complex components.Use utility className
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    rather than horizontally.Split button dropdowns
