              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    create tabbable panes of local content, even via
                    dropdown menus.
                  </p>
                      ...
                      <Row>
                        <Col sm="12">
                          <CardText className="mb-0">
                            ...
                            of them jean shorts Austin. Nesciunt tofu
                      ...
                      <Row>
                        <Col sm="12">
                          <CardText className="mb-0">
                            ...
                            mollit. Keytar helvetica VHS salvia yr,
                            vero magna velit sapiente labore
                            stumptown. Vegan fanny pack odio cillum
                            wes anderson 8-bit.
                          </CardText>
                        </Col>
                      </Row>
                      ...
                      <Row>
                        <Col sm="12">
                          <CardText className="mb-0">
                            ...
                            Messenger bag gentrify pitchfork tattooed
                            craft beer, iphone skateboard locavore
                            carles etsy salvia banksy hoodie
                            helvetica. DIY synth PBR banksy irony.
                            Leggings gentrify squid 8-bit cred
                            pitchfork. Williamsburg banh mi whatever
                            gluten-free, carles pitchfork biodiesel
                            fixie etsy retro mlkshk vice blog.
                            Scenester cred you probably haven&apos;t
                            heard of them, vinyl craft beer blog
                            stumptown. Pitchfork sustainable tofu
                            synth chambray yr.
                          </CardText>
                        </Col>
                      </Row>
                      ...
                      <Row>
                        <Col sm="12">
                          <CardText className="mb-0">
                            ...
                            scenester freegan cosby sweater. Fanny
                            pack portland seitan DIY, art party
                            locavore wolf cliche high life echo park
                            Austin. Cred vinyl keffiyeh DIY salvia
                            PBR, banh mi before they sold out
                            farm-to-table VHS viral locavore cosby
                            sweater. Lomo wolf viral, mustache
                            readymade thundercats keffiyeh craft beer
                            marfa ethical. Wolf salvia freegan,
                    ...
                    <Col md="9">
                      ...
                      >
                        ...
                        <TabPane tabId="2">
                          ...
                          <p className="mb-0">
                            {" "}
                            Qui photo booth letterpress, commodo enim
                            craft beer mlkshk aliquip jean shorts
                        ...
                        <TabPane tabId="4">
                          ...
                          <p className="mb-0">
                            Fanny pack portland seitan DIY, art party
                            locavore wolf cliche high life echo park
                            Austin. Cred vinyl keffiyeh DIY salvia
                            PBR, banh mi before they sold out
                            farm-to-table.
              ...
              <CardBody>
                <Row>
                  <Col lg={6}>
                    ...
                    <p className="card-title-desc">
                      Click the accordions below to expand/collapse
                  ...
                  <Col lg={6}>
                    <div className="mt-4">
                      ...
                      <p className="card-title-desc">
                        Add <code>.accordion-flush</code> to remove
                        the default <code>background-color</code>,
                        some borders, and some rounded corners to
                        render accordions edge-to-edge with their
                        parent container.
                      </p>
                    ...
                    <Col xl="6">
                      <div className="mt-4">
                        ...
                        <p className="card-title-desc">
                          ...
                          multiple elements by referencing them with a
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    collapsing. Add the{" "}
                    <code>.collapse-horizontal</code> modifier class
                    to transition the <code>width</code> instead of{" "}
                    <code>height</code> and set a <code>width</code>{" "}
