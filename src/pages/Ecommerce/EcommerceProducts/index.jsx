...
const EcommerceProducts = props => {
  //meta title
  document.title =
    "Products | Skote - Vite React Admin & Dashboard Template"
  ...
  */
  const onChangeRating = value => {
    setProductList(
      productsData.filter(product => product.rating >= value)
    )
  ...
  const onUncheckMark = value => {
    var modifiedRating = [...ratingvalues]
    const modifiedData = (modifiedRating || []).filter(
      x => x !== value
    )
    /*
    find min values
                  ...
                  <div className="mt-4 pt-3">
                    ...
                    <div>
                      <div className="form-check mt-2">
                        ...
                        >
                          4 <i className="bx bx-star text-warning" />{" "}
                          & Above
                        </Label>
                      </div>
                      <div className="form-check mt-2">
                        ...
                        >
                          3 <i className="bx bx-star text-warning" />{" "}
                          & Above
                        </Label>
                      </div>
                      <div className="form-check mt-2">
                        ...
                        >
                          2 <i className="bx bx-star text-warning" />{" "}
                          & Above
                        </Label>
                      </div>
                      <div className="form-check mt-2">
